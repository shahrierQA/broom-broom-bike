...
var signup = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(name, email, password, passwordConfirm, phoneNumber) {
    var resSignup;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 7:
            ...
            (0, _alert.showAlert)('error', 'Error logout! Please try again.');
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"recoverPassword.js":[function(require,module,exports) {
"use strict";
...
var resetPassword = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(password, passwordConfirm, tokenID) {
    var resResetPassword;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
...
var createBicycle = /*#__PURE__*/function () {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            resAddBicycle = _context.sent;

            if (resAddBicycle.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Bicycle adding successfully');
              window.setTimeout(function () {
                location.assign('/');
              }, 1000);
            }
  ...
  return function createBicycle(_x) {
    return _ref.apply(this, arguments);
  };
}();
...
exports.postReview = exports.editReview = void 0;
...
var postReview = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(review, rating, bicycleId) {
    var resPostReview;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (resPostReview.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Posted a review successfully');
...
var editReview = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(review, rating, bicycleId, reviewId) {
    var resEditReview;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: "/api/v1/bicycle/".concat(bicycleId, "/review/edit/").concat(reviewId),
              data: {
                review: review,
                rating: rating
              }
          ...
          case 3:
            resEditReview = _context2.sent;

            if (resEditReview.data.status === 'success') {
              (0, _alert.showAlert)('success', 'updated review successfully');
              window.location.reload();
            }
          ...
          case 7:
            _context2.prev = 7;
            _context2.t0 = _context2["catch"](0);
            (0, _alert.showAlert)('error', _context2.t0.response.data.message); // console.log(err.response);
  ...
  return function editReview(_x4, _x5, _x6, _x7) {
    return _ref2.apply(this, arguments);
  };
}();

exports.editReview = editReview;
},{"./alert":"alert.js","axios":"../../node_modules/axios/index.js"}],"booking.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.resetBookingDetails = exports.bookingDetails = void 0;
...
var bookingDetails = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(pickUpLocation, bicycleId, quantity, bookedForHours) {
    var resBookingDetails;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
  ...
  return function bookingDetails(_x, _x2, _x3, _x4) {
    return _ref.apply(this, arguments);
  };
}();
...
var resetBookingDetails = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(bicycleSlug, bicycleId) {
    var resResetDetails;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
  ...
  return function resetBookingDetails(_x5, _x6) {
    return _ref2.apply(this, arguments);
  };
}();

exports.resetBookingDetails = resetBookingDetails;
...
var stripe = Stripe("pk_test_51Iw4EZGFvcRRhQxDKYklOK5h0XBXkZGqoEYyN6eC2OXrEAIBKa8RiaeIqSRMnaI178u6lvJvlmYjRbbMnxx76A9U00LtpVpMO5"); // 1. get checkout session from API /checkout-session/:bicycleId
// 2. use stripe object to automatically create checkout form + charge credit cards

var bookBicycle = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(bicycleId) {
    var bookingSession;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return (0, _axios.default)("/api/v1/booking/checkout-session/".concat(bicycleId));

          case 3:
            bookingSession = _context.sent;
            _context.next = 6;
  ...
  return function bookBicycle(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.bookBicycle = bookBicycle;
...
var resetForm = document.getElementById("form-resetPassword");
var logoutBtn = document.getElementById("user-logout");
var userProfileForm = document.getElementById("form-update-profile");
var userPasswordForm = document.getElementById("form-update-password");
var bicycleReviewFormCreate = document.getElementById("form-review-create");
var bicycleReviewFormEdit = document.getElementById("form-review-edit");
...
if (bookingBiycleForm) {
  bookingBiycleForm.addEventListener("submit", function (e) {
    ...
    var bicycleId = document.getElementById("booking__bicycle-id").value;
...
if (bicycleReviewFormCreate) {
  bicycleReviewFormCreate.addEventListener("submit", /*#__PURE__*/function () {
    var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(e) {
      var review, rating, bicycleId;
...
if (bicycleReviewFormEdit) {
  bicycleReviewFormEdit.addEventListener("submit", /*#__PURE__*/function () {
    var _ref5 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(e) {
      var review, rating, bicycleId, reviewId;
        ...
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              ...
              _context5.next = 8;
              return (0, _review.editReview)(review, rating, bicycleId, reviewId);
        ...
        while (1) {
          switch (_context6.prev = _context6.next) {
            case 0:
              ...
              form.append("description", document.getElementById("bike-description").value);
